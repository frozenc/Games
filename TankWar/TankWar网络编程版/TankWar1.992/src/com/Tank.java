...
/*        if(!good) {
    ...
    public void locateDirection() {
        ...
        if(dir != oldDir) {
            TankMoveMsg msg = new TankMoveMsg(this.id, this.x, this.y, this.dir, this.barrelDir);
            tc.nc.send(msg);
        }
    }
    ...
    public Missile fire() {
        ...
        Missile m = new Missile(id, x, y, this.good, barrelDir, tc);
        tc.missiles.add(m);
